...
Settlement records live under `.healthos-steward/settlements/`:
- Active records: `.healthos-steward/settlements/active/`
- Completed records: `.healthos-steward/settlements/completed/`
- Template and schema: `.healthos-steward/settlements/templates/`

The canonical blank template is: `.healthos-steward/settlements/templates/settlement-template.md`

The JSON Schema for machine validation is: `.healthos-steward/settlements/templates/settlement.schema.json`
...
- **Type**: list of strings
- **Required**: yes
- **Format**: Settler Profile IDs from the ST-012 Settler Profile Registry under `.healthos-settler/settlers/`. Each ID must match a file `<id>.md` in that directory.
...
1. **Select a task**: choose the next READY task from `docs/execution/21-structural-ontology-and-product-readiness-plan.md` or the ST construction sequence in `docs/execution/19-settler-model-task-tracker.md`.
...
4. **Identify Territory and Settler Profile**: use Territory IDs from `.healthos-settler/territories/` and Settler Profile IDs from `.healthos-settler/settlers/`. Only use IDs that have corresponding records.
...
12. **Place the file**: use the template at `.healthos-steward/settlements/templates/settlement-template.md`. Save active Settlements under `.healthos-steward/settlements/active/`. Move to `.healthos-steward/settlements/completed/` after all done-criteria are met and tracking is updated.

13. **Update tracking**: after completion, update `docs/execution/02-status-and-tracking.md`, `docs/execution/19-settler-model-task-tracker.md`, and any relevant `docs/execution/todo/*.md`.
...
- Blank template: `.healthos-steward/settlements/templates/settlement-template.md`
- JSON Schema: `.healthos-steward/settlements/templates/settlement.schema.json`
- Territory Registry: `.healthos-settler/territories/`
- Settler Profile Registry: `.healthos-settler/settlers/`
- Construction Operating Model: `docs/execution/22-steward-construction-operating-model.md`
- Architecture doctrine: `docs/architecture/47-steward-settler-engineering-model.md`
- ST task tracker: `docs/execution/19-settler-model-task-tracker.md`
