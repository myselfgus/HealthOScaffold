...
References Territory record: `.healthos-settler/territories/operations-and-observability.json`
...
1. `docs/architecture/04-networking.md` — network fabric and transport contracts
2. `docs/architecture/14-operations-runbook.md` — operator runbook including bootstrap, daily/weekly checks, and incident-response command vocabulary
3. `docs/architecture/15-mesh-provider.md` — mesh provider and service fabric design
4. `docs/architecture/26-operator-observability-contract.md` — observability indicators, alert classes, and operator visibility contract
5. `docs/execution/10-invariant-matrix.md` — operational invariants
6. `docs/execution/skills/network-fabric-skill.md` — network fabric engineering skill reference
7. `docs/execution/skills/backup-restore-retention-export-skill.md` — backup, restore, retention, and export skill
...
- `docs/architecture/14-operations-runbook.md` — primary runbook document
- `docs/architecture/26-operator-observability-contract.md` — observability contract
- `ops/` — operations scripts and governance artifacts (if present)
- `scripts/` — repository validation and operations scripts
- `docs/execution/todo/ops-network-ml.md` — operations/network domain TODO tracker
...
2. Updated TODO entry in `docs/execution/todo/ops-network-ml.md` reflecting task status.
