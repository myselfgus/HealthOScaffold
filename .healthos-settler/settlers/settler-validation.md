...
References Territory record: `.healthos-settler/territories/validation-and-ci.json`
...
1. `docs/execution/10-invariant-matrix.md` — non-negotiable invariants that validation must enforce
2. `docs/execution/README.md` — execution governance and phase-gate protocol
3. `docs/execution/06-scaffold-coverage-matrix.md` — coverage matrix mapping domains to test coverage status
4. `docs/execution/13-scaffold-release-candidate-criteria.md` — release candidate criteria and scaffold RC gate
5. `docs/execution/14-final-gap-register.md` — final gap register for scaffold RC
6. `docs/execution/skills/testing/SKILL.md` — testing engineering skill reference (if present at this path)
...
- `ts/` — TypeScript build and test configuration (when affecting validation targets)
- `.github/` — CI configuration (when present)
- `docs/execution/06-scaffold-coverage-matrix.md` — coverage matrix doc
- `docs/execution/13-scaffold-release-candidate-criteria.md` — RC criteria doc
- `docs/execution/todo/` — relevant TODO tracker files

Forbidden paths (must not propose writes here):

- `swift/Sources/HealthOSCore/` — Core source (changes require Core Settler)
- `swift/Sources/HealthOSAACI/` — AACI source (changes require AACI Settler)
- `ts/agent-infra/healthos-steward/src/` — Steward source (changes require Xcode Tooling Settler)
