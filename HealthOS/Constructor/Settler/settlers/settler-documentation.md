...
References Territory record: `HealthOS/Constructor/Settler/territories/documentation.json`
...
4. `HealthOS/Shared/docs/architecture/17-glossary.md` — canonical nomenclature (Session Runtime, MSR, HealthOS Forge MCP, healthos-forge-mcp)
5. `HealthOS/Shared/docs/execution/10-invariant-matrix.md` — non-negotiable invariants for the full system
6. `HealthOS/Shared/docs/execution/02-status-and-tracking.md` — current task status and tracking baseline
7. `HealthOS/Shared/docs/execution/12-next-agent-handoff.md` — current handoff state for the next agent
8. `HealthOS/Shared/docs/execution/skills/documentation-drift-skill.md` — documentation drift engineering skill reference
...
- `HealthOS/Shared/docs/` — all documentation under `HealthOS/Shared/docs/` including architecture, execution, product, ADRs
- `HealthOS/Constructor/Settler/` — documentation-only construction metadata
- `HealthOS/Constructor/Steward/` — Steward derived state and session docs
- `HealthOS/Shared/docs/execution/todo/` — domain-specific TODO tracker files
- `HealthOS/Shared/docs/execution/skills/` — engineering skill reference docs
...
- `HealthOS/Tier1-Mestral-Core/SQL/`
...
2. Official docs (`HealthOS/Shared/docs/`) remain canonical over derived memory and construction records.
...
2. Updated TODO entries in relevant `HealthOS/Shared/docs/execution/todo/*.md` files reflecting task status.
