...
References Territory record: `HealthOS/Constructor/Settler/territories/gos.json`
...
1. `HealthOS/Shared/docs/architecture/29-governed-operational-spec.md` — GOS spec definition and structure
2. `HealthOS/Shared/docs/architecture/30-gos-compiler.md` — GOS compiler design and output contracts
3. `HealthOS/Shared/docs/architecture/31-gos-lifecycle.md` — GOS lifecycle phases (draft → review → activate → retire)
4. `HealthOS/Shared/docs/architecture/32-gos-runtime-binding.md` — GOS runtime binding and app consumption model
5. `HealthOS/Shared/docs/architecture/33-gos-app-consumption.md` — how apps consume mediated GOS surfaces
6. `HealthOS/Shared/docs/architecture/34-gos-review-and-activation-policy.md` — GOS review and activation policy
7. `HealthOS/Shared/docs/execution/10-invariant-matrix.md` — invariants for GOS sovereignty boundary
8. `HealthOS/Shared/docs/execution/skills/gos-skill.md` — GOS engineering skill reference
...
- `HealthOS/Tier2-GOS-Runtimes/GOS/specs/` — GOS spec authoring files
- `HealthOS/Tier1-Mestral-Core/Schemas/governed-operational-spec.json` — GOS JSON Schema
- `HealthOS/Tier1-Mestral-Core/Schemas/governed-operational-spec-*.json` — GOS variant schemas
- `HealthOS/Constructor/ts/packages/healthos-gos-tooling/` — GOS compiler and tooling package
- `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/GovernedOperationalSpec.swift` — Core-level GOS Swift contract
- `HealthOS/Shared/docs/execution/todo/gos.md` — GOS domain TODO tracker (if present)
