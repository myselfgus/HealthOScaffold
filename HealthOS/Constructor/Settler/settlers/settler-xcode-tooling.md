...
References Territory record: `HealthOS/Constructor/Settler/territories/construction-system.json`
...
1. `HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md` — Steward for Xcode, Xcode Intelligence integration posture, tool runtime contracts
2. `HealthOS/Shared/docs/architecture/46-apple-sovereignty-architecture.md` — Apple sovereignty boundary and Xcode Intelligence scope
3. `HealthOS/Shared/docs/architecture/47-steward-settler-engineering-model.md` — canonical Steward/Settler/Settlement/Territory/Forge MCP architecture
4. `HealthOS/Shared/docs/execution/17-healthos-xcode-agent-migration-plan.md` — Xcode agent migration plan and workstream definitions
5. `HealthOS/Shared/docs/execution/19-settler-model-task-tracker.md` — ST construction sequence tracker
6. `HealthOS/Shared/docs/execution/22-steward-construction-operating-model.md` — construction operating model baseline
7. `HealthOS/Shared/docs/execution/skills/project-steward-skill.md` — project Steward engineering skill reference
...
- `HealthOS/Constructor/Settler/` — Settler profile registry, territory registry, and future settlement records
- `HealthOS/Constructor/Steward/` — Steward derived memory, sessions, prompts, and automation state
- `HealthOS/Constructor/ts/agent-infra/healthos-steward/` — deterministic Steward CLI source
- `HealthOS/Constructor/ts/agent-infra/healthos-forge-mcp/` — HealthOS Forge MCP stdio server (ST-018)
...
- `HealthOS/Shared/docs/execution/19-settler-model-task-tracker.md` — ST construction tracker
- `HealthOS/Shared/docs/execution/22-steward-construction-operating-model.md` — construction operating model
...
```bash
python3 -m json.tool HealthOS/Constructor/Settler/territories/territory.schema.json >/dev/null
for f in HealthOS/Constructor/Settler/territories/*.json; do python3 -m json.tool "$f" >/dev/null && echo "OK: $f" || echo "FAIL: $f"; done
```
...
2. Updated ST construction tracker entry in `HealthOS/Shared/docs/execution/19-settler-model-task-tracker.md`.
3. Updated construction operating model entry in `HealthOS/Shared/docs/execution/22-steward-construction-operating-model.md` if the ST sequence changed.
