...
**Location**: `HealthOS/Constructor/Steward/prompts/prompt-architecture-template.md`
...
2. `README.md`
3. `HealthOS/Shared/docs/execution/01-agent-operating-protocol.md`
4. `HealthOS/Shared/docs/execution/21-structural-ontology-and-product-readiness-plan.md`
5. `HealthOS/Shared/docs/execution/22-steward-construction-operating-model.md`
6. `HealthOS/Shared/docs/product/01-healthos-technical-product-specification.md`, if present
7. `HealthOS/Shared/docs/architecture/17-glossary.md`
...
TypeScript work may require:
  ...
  cd HealthOS/Constructor/ts && npm ls --workspaces --depth=0
  cd HealthOS/Constructor/ts && npm run build --workspaces
  make ts-build
...
- HealthOS/Shared/docs/tracking updated
...
- This template is a construction-system artifact under `HealthOS/Constructor/Steward/prompts/`.
