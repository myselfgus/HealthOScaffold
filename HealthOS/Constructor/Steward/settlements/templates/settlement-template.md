...
<!-- Instructions: copy this file to HealthOS/Constructor/Steward/settlements/active/<slug>.md, replace all <PLACEHOLDER> values, then move to HealthOS/Constructor/Steward/settlements/completed/ when all done-criteria are met. -->
<!-- Schema spec: HealthOS/Constructor/Settler/settlements/SCHEMA.md -->
...
**territory**:
<!-- Territory IDs from HealthOS/Constructor/Settler/territories/. Each ID must match a file <id>.json in that directory. -->
...
**settler-profile**:
<!-- Settler Profile IDs from HealthOS/Constructor/Settler/settlers/. Each ID must match a file <id>.md in that directory. -->
...
- `<DOC-PATH-1>` <!-- e.g., HealthOS/Shared/docs/execution/22-steward-construction-operating-model.md -->
- `<DOC-PATH-2>` <!-- e.g., HealthOS/Shared/docs/architecture/47-steward-settler-engineering-model.md -->
