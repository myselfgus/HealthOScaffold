# Proposta de UX Copy — CloudClinic
...
- Antes:
```
"HealthOSCloudClinic: scaffold placeholder - no final UI shell, no session behavior, no clinical authority (see HealthOS/Shared/docs/architecture/13-cloudclinic.md)"
```
- Depois:
```
