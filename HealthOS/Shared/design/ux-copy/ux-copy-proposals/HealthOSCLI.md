...
Execute o comando a partir da raiz do repositório, ou verifique se o diretório existe:
  <raiz>/HealthOS/Shared/runtime-data/Users/Shared/HealthOS
```
...
DOCUMENTAÇÃO
  HealthOS/Shared/docs/architecture/ — arquitetura de componentes
  HealthOS/Shared/docs/execution/    — protocolos operacionais
```
