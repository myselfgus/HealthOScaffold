...
code_references:
  - path: HealthOS/Shared/docs/architecture/50-app-layer-boundary-and-reference-apps.md
    type: resource
    note: Canonical architecture doc for app-agnostic layering and task ordering.
  - path: HealthOS/Shared/docs/execution/21-structural-ontology-and-product-readiness-plan.md
    type: resource
...
- **Task ordering.** `HealthOS/Shared/docs/execution/21-structural-ontology-and-product-readiness-plan.md` deve mapear tasks abertas por hierarquia e classe externa:
  1. Core
  2. GOS / Runtimes
  3. Boundary
  4. Stage
