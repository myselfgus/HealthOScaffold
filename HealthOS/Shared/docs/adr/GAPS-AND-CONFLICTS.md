...
- **Por que.** Existe [HealthOS/Shared/docs/architecture/26-operator-observability-contract.md](../architecture/26-operator-observability-contract.md) e código em `HealthOS/Shared/runtime-data/`. **ADR-0007** menciona surfaces de operador, mas não fixa o contrato de observabilidade.
...
- **Por que.** [HealthOS/Shared/docs/architecture/18-schema-governance-audit.md](../architecture/18-schema-governance-audit.md), `make validate-schemas`, `make validate-contracts` mas sem ADR formal.
