...
New Stage shell/wiring work must follow `HealthOS/Shared/docs/architecture/50-app-layer-boundary-and-reference-apps.md`: Core/GOS/runtime surface first, Boundary second, Custom readiness third, Stage implementation last.
...
```text
HealthOS/Tier4-Stages-Cast/<Stage>/Sources/<AppTarget>/
  App/
  Views/
  Models/
  Stores/
