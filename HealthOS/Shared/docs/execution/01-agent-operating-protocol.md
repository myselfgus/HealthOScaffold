...
HealthOScaffold is the historical repository name and construction repository for HealthOS. Treat implemented code/HealthOS/Shared/docs/contracts here as HealthOS work at explicit maturity levels; never imply that HealthOS starts only after foundation-phase closure.
