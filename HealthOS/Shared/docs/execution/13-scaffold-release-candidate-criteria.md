...
1. Canonical architecture is coherent across `README.md`, `AGENTS.md`, `CLAUDE.md`, `HealthOS/Shared/docs/architecture/*`, and `HealthOS/Shared/docs/execution/*`.
...
6. Boundary surfaces are contract-protected for initial Stages and future Stage consumers, and do not absorb Core law.
...
| User Agent/Veridia | partial-but-acceptable-with-explicit-gap | boundary contracts/tests exist; adapter/UI incomplete | keep adapter tasks explicit |
