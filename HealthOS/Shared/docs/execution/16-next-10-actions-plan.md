...
2. Boundary-test coverage for non-Scribe runtimes follows blockers (T03)
   so closure tag prep has full app/aaci/HealthOS/Tier2-GOS-Runtimes/GOS/runtime negative coverage.
...
- TODO id: `APP-008` in `HealthOS/Shared/docs/execution/todo/apps-and-interfaces.md`
- Closure mapping: `GAP-001` (scaffold blocker) in `14-final-gap-register.md`
- Phase: Scaffold/Foundation RC Fixes + Tag Prep
- Priority: High
- Skills: `HealthOS/Shared/docs/execution/skills/cross-stage-surfaces-skill.md` +
  `HealthOS/Shared/docs/execution/skills/boundary-skill.md`
- Owner modules:
  - existing contract surface: `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/CrossAppCoordinationContracts.swift`
  - non-Scribe adapters: `HealthOS/Constructor/ts/packages/runtime-user-agent/` (Veridia path) and
    the service-runtime equivalent (CloudClinic) under `HealthOS/Constructor/ts/packages/` plus
...
- Files expected to change:
  ...
  - `HealthOS/Shared/docs/execution/todo/apps-and-interfaces.md` (move APP-008 to COMPLETED)
- Validation:
...
In order:
1. `CLAUDE.md`
2. `HealthOS/Shared/docs/execution/01-agent-operating-protocol.md`
3. `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
4. `HealthOS/Shared/docs/execution/06-scaffold-coverage-matrix.md`
5. `HealthOS/Shared/docs/execution/10-invariant-matrix.md` (pay attention to invariants 4, 31,
   32, 39, 40, 41)
6. `HealthOS/Shared/docs/execution/14-final-gap-register.md` (GAP-001 is the blocker you close)
7. `HealthOS/Shared/docs/execution/todo/apps-and-interfaces.md` (find APP-008)
8. `HealthOS/Shared/docs/execution/skills/cross-stage-surfaces-skill.md`
9. `HealthOS/Shared/docs/execution/skills/boundary-skill.md`
10. `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/CrossAppCoordinationContracts.swift` — read
    fully; this is the contract you propagate
11. `HealthOS/Shared/Tests/HealthOSTests/CrossAppCoordinationContractsTests.swift` —
    existing tests; you extend them
12. `HealthOS/Constructor/ts/packages/runtime-user-agent/src/index.ts` — Veridia adapter seam
13. `HealthOS/Shared/docs/architecture/11-scribe.md`, `12-veridia.md`, `13-cloudclinic.md` —
...
What to do:
- In `HealthOS/Constructor/ts/packages/runtime-user-agent/src/index.ts` (Veridia adapter seam):
...
- If a CloudClinic adapter seam does not exist yet in `HealthOS/Constructor/ts/packages/`, introduce
  ...
  contract only.
- Extend `HealthOS/Shared/Tests/HealthOSTests/CrossAppCoordinationContractsTests.swift`
...
- `HealthOS/Constructor/ts/packages/runtime-user-agent/src/index.ts`
- `HealthOS/Constructor/ts/packages/service-runtime/src/index.ts` (create if absent, minimal)
- `HealthOS/Shared/Tests/HealthOSTests/CrossAppCoordinationContractsTests.swift` (extend)
- `HealthOS/Shared/docs/execution/02-status-and-tracking.md` (add APP-008 completed entry)
- `HealthOS/Shared/docs/execution/06-scaffold-coverage-matrix.md` (update maturity row)
- `HealthOS/Shared/docs/execution/10-invariant-matrix.md` (add parity note on inv. 39/40/41)
- `HealthOS/Shared/docs/execution/14-final-gap-register.md` (mark GAP-001 progress/closure)
- `HealthOS/Shared/docs/execution/todo/apps-and-interfaces.md` (move APP-008 to COMPLETED)
...
- TODO id: `OPS-003` in `HealthOS/Shared/docs/execution/todo/ops-network-ml.md`
- Closure mapping: `GAP-002` (scaffold blocker)
- Phase: Scaffold/Foundation RC Fixes + Tag Prep
- Priority: High
- Skills: `HealthOS/Shared/docs/execution/skills/network-fabric-skill.md` +
...
- Files expected to change:
  ...
  - `HealthOS/Shared/docs/execution/06-scaffold-coverage-matrix.md`
  - `HealthOS/Shared/docs/execution/10-invariant-matrix.md`
  - `HealthOS/Shared/docs/execution/todo/ops-network-ml.md` (move OPS-003 to COMPLETED)
- Validation:
  - `make validate-docs`
  - `make validate-all`
- Anti-overclaim:
...
2. `HealthOS/Shared/docs/execution/01-agent-operating-protocol.md`
3. `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
4. `HealthOS/Shared/docs/execution/14-final-gap-register.md` (GAP-002 is the blocker you close)
5. `HealthOS/Shared/docs/execution/todo/ops-network-ml.md` (find OPS-003 under READY)
6. `HealthOS/Shared/docs/execution/skills/network-fabric-skill.md`
7. `HealthOS/Shared/docs/execution/skills/backup-restore-retention-export-skill.md`
8. `HealthOS/Shared/docs/architecture/14-operations-runbook.md` — existing runbook; you extend it
9. `HealthOS/Shared/docs/architecture/26-operator-observability-contract.md` — existing
   observability contract; you extend it
10. `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/BackupGovernance.swift` — backup event kinds
11. `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/AsyncRuntimeJobs.swift` — async job states
...
What to do in `HealthOS/Shared/docs/architecture/14-operations-runbook.md`:
...
What to do in `HealthOS/Shared/docs/architecture/26-operator-observability-contract.md`:
...
- `HealthOS/Shared/docs/architecture/14-operations-runbook.md`
- `HealthOS/Shared/docs/architecture/26-operator-observability-contract.md`
- `HealthOS/Shared/docs/execution/02-status-and-tracking.md` (add OPS-003 completed entry)
- `HealthOS/Shared/docs/execution/06-scaffold-coverage-matrix.md` (update ops row)
- `HealthOS/Shared/docs/execution/10-invariant-matrix.md` (add note on incident-response
  vocabulary coverage if a new invariant is warranted)
- `HealthOS/Shared/docs/execution/14-final-gap-register.md` (mark GAP-002 progress/closure)
- `HealthOS/Shared/docs/execution/todo/ops-network-ml.md` (move OPS-003 to COMPLETED)
...
- TODO id: `RT-008` in `HealthOS/Shared/docs/execution/todo/runtimes-and-aaci.md`
- Closure mapping: `GAP-009`
- Phase: Scaffold/Foundation RC Fixes + Tag Prep
- Priority: High
- Skills: `HealthOS/Shared/docs/execution/skills/async-runtime-skill.md` +
  `HealthOS/Shared/docs/execution/skills/aaci-skill.md`
- Owner modules:
  - `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/UserSovereigntyContracts.swift`
  - `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/ServiceOperationsContracts.swift`
  - `HealthOS/Tier2-GOS-Runtimes/Sources/HealthOSAACI/AACI.swift` (boundary surfaces)
- Scope:
  ...
  - Service-runtime boundary negatives: cross-service leakage,
    ...
    protection.
  - Boundary surfaces tested across app/aaci/HealthOS/Tier2-GOS-Runtimes/GOS/runtime layers where
    currently contract-only.
- Definition of done:
  - Boundary denials are tested across app/aaci/HealthOS/Tier2-GOS-Runtimes/GOS/runtime surfaces where
    currently contract-only.
  - Honesty preserved for stubs (no fabricated capabilities).
- Files expected to change:
  - `HealthOS/Shared/Tests/HealthOSTests/UserSovereigntyGovernanceTests.swift` (extend)
  - `HealthOS/Shared/Tests/HealthOSTests/ServiceOperationsGovernanceTests.swift` (extend)
  - optional: new dedicated runtime-adapter boundary test file
  - `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
  - `HealthOS/Shared/docs/execution/06-scaffold-coverage-matrix.md`
  - `HealthOS/Shared/docs/execution/10-invariant-matrix.md`
  - `HealthOS/Shared/docs/execution/todo/runtimes-and-aaci.md` (move RT-008 to COMPLETED)
- Validation:
  - `make swift-test`
  - `make validate-all`
- Anti-overclaim:
...
2. `HealthOS/Shared/docs/execution/01-agent-operating-protocol.md`
3. `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
4. `HealthOS/Shared/docs/execution/10-invariant-matrix.md` (focus on invariants 31–38)
5. `HealthOS/Shared/docs/execution/14-final-gap-register.md` (GAP-009)
6. `HealthOS/Shared/docs/execution/todo/runtimes-and-aaci.md` (find RT-008)
7. `HealthOS/Shared/docs/execution/skills/async-runtime-skill.md`
8. `HealthOS/Shared/docs/execution/skills/aaci-skill.md`
9. `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/UserSovereigntyContracts.swift`
10. `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/ServiceOperationsContracts.swift`
11. `HealthOS/Tier2-GOS-Runtimes/Sources/HealthOSAACI/AACI.swift`
12. `HealthOS/Shared/Tests/HealthOSTests/UserSovereigntyGovernanceTests.swift`
13. `HealthOS/Shared/Tests/HealthOSTests/ServiceOperationsGovernanceTests.swift`
...
What to add in `HealthOS/Shared/Tests/HealthOSTests/UserSovereigntyGovernanceTests.swift`:
...
What to add in `HealthOS/Shared/Tests/HealthOSTests/ServiceOperationsGovernanceTests.swift`:
...
- `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
- `HealthOS/Shared/docs/execution/06-scaffold-coverage-matrix.md`
- `HealthOS/Shared/docs/execution/10-invariant-matrix.md` (mark RT-008 coverage row closed)
- `HealthOS/Shared/docs/execution/14-final-gap-register.md` (mark GAP-009 progress)
- `HealthOS/Shared/docs/execution/todo/runtimes-and-aaci.md` (move RT-008 to COMPLETED)
...
- TODO id: `DS-007` in `HealthOS/Shared/docs/execution/todo/data-storage.md`
...
- Priority: High
- Skill: `HealthOS/Shared/docs/execution/skills/storage-data-layer-skill.md`
- Owner modules:
  ...
  - non-first-slice consumers across `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/*`
- Scope:
...
- Files expected to change:
  - `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/*` (call sites needing parity)
  - test files extending storage-related coverage
  - `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
  - `HealthOS/Shared/docs/execution/06-scaffold-coverage-matrix.md`
  - `HealthOS/Shared/docs/execution/10-invariant-matrix.md`
  - `HealthOS/Shared/docs/execution/todo/data-storage.md` (move DS-007 to COMPLETED)
- Validation:
  - `make swift-test`
  - `make validate-all`
- Anti-overclaim:
...
2. `HealthOS/Shared/docs/execution/01-agent-operating-protocol.md`
3. `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
4. `HealthOS/Shared/docs/execution/10-invariant-matrix.md` (invariants 14, 15, 21, 23, 26)
5. `HealthOS/Shared/docs/execution/14-final-gap-register.md` (GAP-003 — note next-maturity
   scope; file-backed parity is in-scope, SQL/object is not)
6. `HealthOS/Shared/docs/execution/todo/data-storage.md` (find DS-007)
7. `HealthOS/Shared/docs/execution/skills/storage-data-layer-skill.md`
8. `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/StorageContracts.swift` — the contract types
9. `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/FirstSliceServices.swift` — reference impl
10. `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/BackupGovernance.swift` — adjacent contracts
11. All other files under `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/` that expose storage,
...
1. Audit every `put`, `get`, `list`, `audit`, `delete`, `export`, and
   `restore` call site in `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/` that does not yet
...
- `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/` (targeted call sites — identify via audit)
- Existing or new test files under `HealthOS/Shared/Tests/HealthOSTests/` covering
  newly guarded call sites
- `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
- `HealthOS/Shared/docs/execution/06-scaffold-coverage-matrix.md`
- `HealthOS/Shared/docs/execution/10-invariant-matrix.md` (update invariants 14, 15 parity row)
- `HealthOS/Shared/docs/execution/todo/data-storage.md` (move DS-007 to COMPLETED)
...
- TODO id: `APP-009` in `HealthOS/Shared/docs/execution/todo/apps-and-interfaces.md`
- Closure mapping: scaffold cleanup (no separate gap row)
- Phase: Scaffold/Foundation RC Fixes + Tag Prep
- Priority: Medium
- Blocked by: T01 (claims must reflect actual adapter posture).
- Skill: `HealthOS/Shared/docs/execution/skills/documentation-drift-skill.md`
- Scope:
...
2. `HealthOS/Shared/docs/execution/01-agent-operating-protocol.md`
3. `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
4. `HealthOS/Shared/docs/execution/06-scaffold-coverage-matrix.md` — current maturity table
5. `HealthOS/Shared/docs/execution/11-current-maturity-map.md`
6. `HealthOS/Shared/docs/execution/10-invariant-matrix.md` (invariant 43: foundation closure ≠
   product readiness)
7. `HealthOS/Shared/docs/execution/todo/apps-and-interfaces.md` (find APP-009)
8. `HealthOS/Shared/docs/execution/skills/documentation-drift-skill.md`
9. `HealthOS/Shared/docs/architecture/11-scribe.md`
10. `HealthOS/Shared/docs/architecture/12-veridia.md`
11. `HealthOS/Shared/docs/architecture/13-cloudclinic.md`
12. `HealthOS/Shared/docs/architecture/19-interface-doctrine.md`
...
- `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
- `HealthOS/Shared/docs/execution/todo/apps-and-interfaces.md` (move APP-009 to COMPLETED)
...
- TODO id: `AACI-009` in `HealthOS/Shared/docs/execution/todo/runtimes-and-aaci.md`
- Closure mapping: scaffold cleanup
- Phase: Scaffold/Foundation RC Fixes + Tag Prep
- Priority: Medium
- Skills: `HealthOS/Shared/docs/execution/skills/aaci-skill.md` +
  `HealthOS/Shared/docs/execution/skills/provider-governance-skill.md`
- Owner modules:
...
- Files expected to change:
  ...
  - `HealthOS/Shared/docs/execution/06-scaffold-coverage-matrix.md`
  - `HealthOS/Shared/docs/execution/10-invariant-matrix.md`
  - `HealthOS/Shared/docs/execution/todo/runtimes-and-aaci.md` (move AACI-009 to COMPLETED)
- Validation:
  - `make swift-test`
  - `make validate-all`
- Anti-overclaim:
...
2. `HealthOS/Shared/docs/execution/01-agent-operating-protocol.md`
3. `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
4. `HealthOS/Shared/docs/execution/10-invariant-matrix.md` (invariants 18, 21, 22, 23)
5. `HealthOS/Shared/docs/execution/todo/runtimes-and-aaci.md` (find AACI-009)
6. `HealthOS/Shared/docs/execution/skills/aaci-skill.md`
7. `HealthOS/Shared/docs/execution/skills/provider-governance-skill.md`
8. `HealthOS/Tier2-GOS-Runtimes/Sources/HealthOSAACI/AACI.swift`
9. `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/RetrievalMemoryGovernance.swift`
10. `HealthOS/Tier2-GOS-Runtimes/Sources/HealthOSProviders/StubProviders.swift`
11. `HealthOS/Shared/Tests/HealthOSTests/ProviderGovernanceTests.swift`
12. `HealthOS/Shared/docs/architecture/09-aaci.md`
13. `HealthOS/Shared/docs/architecture/16-providers-and-ml.md`
...
What to do in docs:
- In `HealthOS/Shared/docs/architecture/09-aaci.md`: add or verify a "Capability honesty"
...
- In `HealthOS/Shared/docs/architecture/16-providers-and-ml.md`: align provider capability
...
- `HealthOS/Shared/Tests/HealthOSTests/ProviderGovernanceTests.swift` (extend)
- `HealthOS/Shared/docs/architecture/09-aaci.md`
- `HealthOS/Shared/docs/architecture/16-providers-and-ml.md`
- `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
- `HealthOS/Shared/docs/execution/06-scaffold-coverage-matrix.md`
...
- TODO id: `CL-006` in `HealthOS/Shared/docs/execution/todo/core-laws.md`
...
- Priority: Medium
- Skill: `HealthOS/Shared/docs/execution/skills/core-law-skill.md`
- Scope:
  ...
  - If approved, add a minimal schema under `HealthOS/Tier1-Mestral-Core/Schemas/contracts/` (e.g.,
...
- Files expected to change:
  ...
  - optional: new contract under `HealthOS/Tier1-Mestral-Core/Schemas/contracts/`
  - `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
  - `HealthOS/Shared/docs/execution/todo/core-laws.md`
- Validation:
...
2. `HealthOS/Shared/docs/execution/01-agent-operating-protocol.md`
3. `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
4. `HealthOS/Shared/docs/execution/todo/core-laws.md` (find CL-006)
5. `HealthOS/Shared/docs/execution/skills/core-law-skill.md`
6. `HealthOS/Shared/docs/architecture/06-core-services.md` — the loopback seam description
7. `HealthOS/Shared/docs/adr/0006-*.md` — ADR that established the Swift ↔ TS loopback
8. `HealthOS/Tier1-Mestral-Core/Schemas/contracts/` — existing schema conventions for formatting reference
9. `HealthOS/Constructor/ts/packages/contracts/src/index.ts` — existing TS contract types
...
1. Add `HealthOS/Tier1-Mestral-Core/Schemas/contracts/service-boundary-outcome.schema.json` with the
   above structure (draft-07 JSON Schema, consistent with repo conventions).
2. Add the matching TypeScript type to `HealthOS/Constructor/ts/packages/contracts/src/index.ts`.
3. Add a brief Swift struct or enum to `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/` if the
   loopback seam has a Swift side.
4. Update `HealthOS/Shared/docs/architecture/06-core-services.md` with the outcome
...
- `HealthOS/Shared/docs/architecture/06-core-services.md`
- `HealthOS/Tier1-Mestral-Core/Schemas/contracts/service-boundary-outcome.schema.json` (new, if approved)
- `HealthOS/Constructor/ts/packages/contracts/src/index.ts` (add type if approved)
- `HealthOS/Tier1-Mestral-Core/Sources/HealthOSCore/` (add struct if Swift side is relevant)
- `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
- `HealthOS/Shared/docs/execution/todo/core-laws.md` (move CL-006 to COMPLETED)
...
- Priority: Medium
- Skill: `HealthOS/Shared/docs/execution/skills/project-steward-skill.md` (tooling) +
...
- Files expected to change:
  ...
  - `HealthOS/Shared/docs/execution/14-final-gap-register.md` (mark GAP-010 progress)
- Validation:
...
1. `CLAUDE.md`
2. `HealthOS/Shared/docs/execution/01-agent-operating-protocol.md`
3. `HealthOS/Shared/docs/execution/14-final-gap-register.md` (GAP-010 description)
4. `HealthOS/Shared/docs/execution/15-scaffold-finalization-plan.md` (validation gate list)
...
- Steps in order:
  ...
  2. Set up Swift (use `swift-actions/setup-swift` or the appropriate action
     for the version in `HealthOS/Package.swift`)
  3. Set up Node.js (use `actions/setup-node@v4` with the version from
     `HealthOS/Constructor/ts/package.json` or `.nvmrc`)
  4. Set up Python (use `actions/setup-python@v5` with version from
     `HealthOS/Support/python/` or `pyproject.toml`)
...
- `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
- `HealthOS/Shared/docs/execution/14-final-gap-register.md` (mark GAP-010 progress)
- `HealthOS/Shared/docs/execution/15-scaffold-finalization-plan.md` (add CI gate reference)
...
3. `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
4. `HealthOS/Shared/docs/execution/06-scaffold-coverage-matrix.md`
5. `HealthOS/Shared/docs/execution/10-invariant-matrix.md`
6. `HealthOS/Shared/docs/execution/11-current-maturity-map.md`
7. `HealthOS/Shared/docs/execution/12-next-agent-handoff.md`
8. `HealthOS/Shared/docs/execution/13-scaffold-release-candidate-criteria.md` — the closure
   decision rule; read every criterion carefully
9. `HealthOS/Shared/docs/execution/14-final-gap-register.md` — GAP-001 and GAP-002 must show
   `scaffold blocker` resolved or explicitly accepted with rationale
10. `HealthOS/Shared/docs/execution/15-scaffold-finalization-plan.md` — the full gate sequence
    you must execute
...
- T03 (RT-008) is merged to `main` and GAP-009 shows `resolved` or
  `explicitly accepted`.
- `HealthOS/Shared/docs/execution/02-status-and-tracking.md` shows all three as completed.

If any prerequisite is not met, stop and record the blocker in
`HealthOS/Shared/docs/execution/02-status-and-tracking.md`. Do not tag.
...
Step 5: Update `HealthOS/Shared/docs/execution/02-status-and-tracking.md` with the tag event
and push.
...
- All execution docs under `HealthOS/Shared/docs/execution/` (sync as needed)
- `HealthOS/Shared/docs/execution/14-final-gap-register.md` (final status)
- `HealthOS/Shared/docs/execution/15-scaffold-finalization-plan.md` (mark gate complete)
...
**Status: completed 2026-04-27** (tracked as `ML-008` in `HealthOS/Shared/docs/execution/todo/ops-network-ml.md`).
...
- Priority: Low
- Skill: `HealthOS/Shared/docs/execution/skills/project-steward-skill.md`
- Owner modules: `HealthOS/Constructor/ts/agent-infra/healthos-steward/src/providers/*` and tests.
- Scope:
...
- `HealthOS/Constructor/ts/agent-infra/healthos-steward/src/providers/types.ts` — expanded
  `StewardLLMFailure['errorKind']` union (17 cases) and `StewardReviewMetadata`
- `HealthOS/Constructor/ts/agent-infra/healthos-steward/src/providers/utils.ts` — mode-aware
  extractors, `classifyHttpError`, `classifyNetworkError`,
  `formatStewardReviewComment`
- `HealthOS/Constructor/ts/agent-infra/healthos-steward/test/providers.test.mjs` — 33 test cases
- `HealthOS/Shared/docs/execution/todo/ops-network-ml.md` ML-008 entry for outcome summary
...
- `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
- the relevant `HealthOS/Shared/docs/execution/todo/*.md` entry (move from `READY` to `COMPLETED` with `Outcome:` and `Files touched:`)
- `HealthOS/Shared/docs/execution/06-scaffold-coverage-matrix.md` if maturity classification shifts
- `HealthOS/Shared/docs/execution/10-invariant-matrix.md` if a new invariant or test parity is enforced
- `HealthOS/Shared/docs/execution/14-final-gap-register.md` if a gap closes or downgrades
...
- `HealthOS/Shared/docs/execution/15-scaffold-finalization-plan.md`
- `HealthOS/Shared/docs/execution/skills/*.md`
