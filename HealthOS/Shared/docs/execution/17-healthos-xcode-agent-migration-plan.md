...
Current goal:
- treat Xcode Intelligence as the native engineering-agent runtime surface per `HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md`
- align engineering posture with Apple sovereignty thesis per `HealthOS/Shared/docs/architecture/46-apple-sovereignty-architecture.md`
...
- official docs (`HealthOS/Shared/docs/`, `README.md`, `CLAUDE.md`, `AGENTS.md`) are canonical; repository memory is derived
...
- align existing skill files under `HealthOS/Shared/docs/execution/skills/` with the simplified target architecture
...
- `HealthOS/Constructor/ts/agent-infra/healthos-forge-mcp/` exists as `@healthos/forge-mcp`
...
Objective: keep `HealthOS/Constructor/ts/agent-infra/healthos-steward` narrow, deterministic, and CI-safe, while expanding implemented repository-maintenance operations only when they are backed by source and local smoke evidence.
...
Outputs:
- `HealthOS/Shared/docs/architecture/46-apple-sovereignty-architecture.md` created
- `HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md` rewritten to Xcode Intelligence extension posture
- `HealthOS/Shared/docs/execution/17-healthos-xcode-agent-migration-plan.md` rewritten (this document)
- `HealthOS/Shared/docs/architecture/44-project-steward-agent.md` marked as historical reference
- `HealthOS/Shared/docs/execution/02-status-and-tracking.md` updated
- `HealthOS/Shared/docs/execution/14-final-gap-register.md` GAP-003 reframed
...
Outputs:
- old provider and prompt orchestration in `HealthOS/Constructor/ts/agent-infra/healthos-steward` deprecated or removed
- deterministic CLI retained, renamed, or absorbed into the MCP server implementation as appropriate
- `HealthOS/Shared/docs/architecture/44-project-steward-agent.md` retained as historical reference; not deleted
...
- delivered MCP tools: the 10 deterministic `steward_*` tools in `HealthOS/Constructor/ts/agent-infra/healthos-forge-mcp/`
...
- memory split:
  - repository memory: derived by HealthOS tooling under `HealthOS/Constructor/Steward/memory/derived/`; never canonical truth
...
- `HealthOS/Constructor/ts/packages/healthos-agent-web` and the multi-package custom agent split
