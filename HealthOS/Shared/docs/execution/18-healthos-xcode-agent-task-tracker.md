...
- file-backed session store at `HealthOS/Constructor/Steward/memory/sessions/`
...
- every work unit must update this tracker and `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
...
- package `HealthOS/Constructor/ts/agent-infra/healthos-steward/` hard-reset from scratch
- new runtime/session baseline created
- session storage directory established at `HealthOS/Constructor/Steward/memory/sessions/`
