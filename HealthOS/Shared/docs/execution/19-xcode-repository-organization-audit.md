...
2. the existing canonical Swift package at `HealthOS/Package.swift`
3. optional future dedicated Apple projects only when an app surface outgrows SwiftPM packaging
4. all non-Apple parts (`HealthOS/Constructor/ts/`, `HealthOS/Support/python/`, `HealthOS/Tier1-Mestral-Core/Schemas/`, `HealthOS/Shared/docs/`, `HealthOS/Tier2-GOS-Runtimes/GOS/`, `HealthOS/Tier1-Mestral-Core/SQL/`, `scripts/`) kept as first-class monorepo folders with their own native tooling
...
HealthOScaffold/
  ...
  HealthOS/Support/python/
  HealthOS/Tier1-Mestral-Core/Schemas/
  HealthOS/Shared/docs/
  HealthOS/Tier2-GOS-Runtimes/GOS/
...
- point to `HealthOS/Package.swift`
