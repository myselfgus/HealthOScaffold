...
**Version**: 1.0 | **Date**: 2026-04-28 | **Plan source**: `HealthOS/Shared/docs/execution/20-documental-todos-work-plan.md`
...
5. **Official docs remain canonical.** Files in `HealthOS/Shared/docs/` are authoritative. Repository-local roots (`HealthOS/Constructor/Settler/`, `HealthOS/Constructor/Territory/`) are derived and subordinate.
6. **No merge authority.** No document grants authority to merge, approve clinical activity, or make regulatory claims.
7. **Tracking is mandatory.** After completing each of the three tasks, update `HealthOS/Shared/docs/execution/02-status-and-tracking.md` AND `HealthOS/Shared/docs/execution/19-settler-model-task-tracker.md` in the same work unit. Never mark a task done without a concrete deliverable.
...
```
1. HealthOS/Shared/docs/execution/20-documental-todos-work-plan.md          ← master plan for this phase
2. HealthOS/Shared/docs/architecture/47-steward-settler-engineering-model.md ← canonical doctrine
3. HealthOS/Shared/docs/execution/19-settler-model-task-tracker.md          ← active task queue (ST-002, ST-003, ST-006)
4. HealthOS/Shared/docs/execution/10-invariant-matrix.md                    ← invariants you must preserve
5. HealthOS/Shared/docs/execution/01-agent-operating-protocol.md            ← operating rules
6. HealthOS/Constructor/Settler/profiles/README.md                     ← profile field spec
7. HealthOS/Constructor/Settler/settlements/README.md                  ← settlement field spec
8. HealthOS/Constructor/Territory/territories/README.md                ← territory field spec
9. HealthOS/Shared/docs/execution/02-status-and-tracking.md                 ← current status (read top 60 lines)
```

After reading all nine files, verify:
- `HealthOS/Shared/docs/architecture/47-steward-settler-engineering-model.md` exists → YES/NO
- `HealthOS/Constructor/Settler/profiles/` directory exists → YES/NO
- `HealthOS/Constructor/Settler/settlements/` directory exists → YES/NO
- `HealthOS/Constructor/Territory/territories/` directory exists → YES/NO
...
**Source**: `HealthOS/Shared/docs/execution/19-settler-model-task-tracker.md` → ST-006
**Target directory**: `HealthOS/Constructor/Territory/territories/`
...
Create one `.md` file per territory in `HealthOS/Constructor/Territory/territories/`. File names are lowercase with hyphens.
...
This Territory record is subordinate to official docs in `HealthOS/Shared/docs/`. It does not grant authority,
...
<!-- Relevant skill docs from HealthOS/Shared/docs/execution/skills/. Verify paths exist. -->
- `HealthOS/Shared/docs/execution/skills/<name>.md`
...
**TERRITORY-CORE-LAW**
- Canonical docs to read first: `HealthOS/Shared/docs/architecture/01-core-overview.md`, `HealthOS/Shared/docs/architecture/06-core-services.md`
...
- Skills: `HealthOS/Shared/docs/execution/skills/core-law-skill.md`

**TERRITORY-STORAGE**
- Canonical docs to read first: `HealthOS/Shared/docs/architecture/07-storage.md`
...
- Skills: `HealthOS/Shared/docs/execution/skills/storage-data-layer-skill.md`

**TERRITORY-GOS**
- Canonical docs to read first: `HealthOS/Shared/docs/architecture/08-gos.md`
...
- Skills: `HealthOS/Shared/docs/execution/skills/gos-skill.md`

**TERRITORY-AACI**
- Canonical docs to read first: `HealthOS/Shared/docs/architecture/10-aaci.md`
...
- Skills: `HealthOS/Shared/docs/execution/skills/aaci-skill.md`, `HealthOS/Shared/docs/execution/skills/provider-governance-skill.md`

**TERRITORY-ASYNC-RUNTIME**
- Canonical docs to read first: `HealthOS/Shared/docs/architecture/11-async-runtime.md`
...
**TERRITORY-PROVIDERS**
- Canonical docs to read first: `HealthOS/Shared/docs/architecture/16-providers-and-ml.md`, `HealthOS/Shared/docs/architecture/27-provider-threshold-policy.md`
...
- Skills: `HealthOS/Shared/docs/execution/skills/provider-governance-skill.md`

**TERRITORY-APPS**
- Canonical docs to read first: `HealthOS/Shared/docs/architecture/03-app-interfaces.md`
...
- Skills: `HealthOS/Shared/docs/execution/skills/boundary-skill.md`, `HealthOS/Shared/docs/execution/skills/cross-stage-surfaces-skill.md`

**TERRITORY-OPS**
- Canonical docs to read first: `HealthOS/Shared/docs/architecture/14-operations-runbook.md`, `HealthOS/Shared/docs/architecture/26-operator-observability-contract.md`
...
- Skills: `HealthOS/Shared/docs/execution/skills/backup-restore-retention-export-skill.md`, `HealthOS/Shared/docs/execution/skills/network-fabric-skill.md`

**TERRITORY-XCODE-TOOLING**
- Canonical docs to read first: `HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md`, `HealthOS/Shared/docs/architecture/44-project-steward-agent.md`, `HealthOS/Shared/docs/architecture/47-steward-settler-engineering-model.md`
...
- Skills: `HealthOS/Shared/docs/execution/skills/project-steward-skill.md`

**TERRITORY-DOCUMENTATION**
- Canonical docs to read first: `HealthOS/Shared/docs/execution/README.md`, `HealthOS/Shared/docs/execution/10-invariant-matrix.md`, `HealthOS/Shared/docs/execution/01-agent-operating-protocol.md`
...
- Skills: `HealthOS/Shared/docs/execution/skills/documentation-drift-skill.md`

**TERRITORY-VALIDATION**
- Canonical docs to read first: `HealthOS/Shared/docs/execution/06-scaffold-coverage-matrix.md`, `HealthOS/Shared/docs/execution/13-scaffold-release-candidate-criteria.md`
...
- Skills: `HealthOS/Shared/docs/execution/skills/validation-skill.md` (if exists; note if missing)

### After completing Task 1

Update `HealthOS/Shared/docs/execution/19-settler-model-task-tracker.md`:
- Change `ST-006` status from `TODO` to `DONE`.
- Add outcome block:
  ```
  Status: DONE
  Outcome:
  - created 11 Territory records under HealthOS/Constructor/Territory/territories/
  - each record contains all required fields per README spec
  Files touched:
  - HealthOS/Constructor/Territory/territories/core-law.md
  - HealthOS/Constructor/Territory/territories/storage.md
  - HealthOS/Constructor/Territory/territories/gos.md
  - HealthOS/Constructor/Territory/territories/aaci.md
  - HealthOS/Constructor/Territory/territories/async-runtime.md
  - HealthOS/Constructor/Territory/territories/providers.md
  - HealthOS/Constructor/Territory/territories/apps.md
  - HealthOS/Constructor/Territory/territories/ops.md
  - HealthOS/Constructor/Territory/territories/xcode-tooling.md
  - HealthOS/Constructor/Territory/territories/documentation.md
  - HealthOS/Constructor/Territory/territories/validation.md
  ```
...
**Source**: `HealthOS/Shared/docs/execution/19-settler-model-task-tracker.md` → ST-002
**Target directory**: `HealthOS/Constructor/Settler/profiles/`
...
**Territory ID**: <TERRITORY-ID>
**Territory record**: `HealthOS/Constructor/Territory/territories/<territory-file>.md`
...
- Updated `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
- Updated relevant `HealthOS/Shared/docs/execution/todo/*.md` entry
...
**Source**: `HealthOS/Shared/docs/execution/19-settler-model-task-tracker.md` → ST-003
**Target file**: `HealthOS/Constructor/Settler/settlements/SCHEMA.md`
...
### Required content for `HealthOS/Constructor/Settler/settlements/SCHEMA.md`
...
| `territory` | string | required | Territory ID from `HealthOS/Constructor/Territory/territories/`. Must match an existing record. |
| `settler-profile` | string | required | Profile ID from `HealthOS/Constructor/Settler/profiles/`. Must match an existing profile. |
...
After completing Tasks 1, 2, and 3, add an entry to `HealthOS/Shared/docs/execution/02-status-and-tracking.md` at the top of the "Completed recently" section:

```markdown
## PHASE-1-SETTLER-TERRITORY — Settler/Territory documentation phase (2026-04-28)

Objective: write all Settler/Territory documental artifacts defined in HealthOS/Shared/docs/execution/20-documental-todos-work-plan.md Phase 1.
...
- HealthOS/Constructor/Territory/territories/documentation.md
- HealthOS/Constructor/Territory/territories/validation.md
- HealthOS/Constructor/Settler/profiles/settler-core-law.md
- HealthOS/Constructor/Settler/profiles/settler-storage.md
- HealthOS/Constructor/Settler/profiles/settler-gos.md
- HealthOS/Constructor/Settler/profiles/settler-aaci.md
- HealthOS/Constructor/Settler/profiles/settler-ops.md
- HealthOS/Constructor/Settler/profiles/settler-apps.md
- HealthOS/Constructor/Settler/profiles/settler-xcode-tooling.md
- HealthOS/Constructor/Settler/profiles/settler-documentation.md
- HealthOS/Constructor/Settler/profiles/settler-validation.md
- HealthOS/Constructor/Settler/settlements/SCHEMA.md
- HealthOS/Shared/docs/execution/19-settler-model-task-tracker.md
- HealthOS/Shared/docs/execution/02-status-and-tracking.md
...
git add HealthOS/Constructor/Settler/settlements/SCHEMA.md HealthOS/Shared/docs/execution/19-settler-model-task-tracker.md HealthOS/Shared/docs/execution/02-status-and-tracking.md
...
- [ ] `HealthOS/Constructor/Territory/territories/` contains exactly 11 `.md` files, one per territory listed above
...
- [ ] `HealthOS/Constructor/Settler/profiles/` contains exactly 9 `.md` files, one per profile listed above
...
- [ ] `HealthOS/Constructor/Settler/settlements/SCHEMA.md` exists and contains all 16 schema fields, status transitions, and an annotated example
- [ ] `HealthOS/Shared/docs/execution/19-settler-model-task-tracker.md` shows ST-006, ST-002, ST-003 as DONE
- [ ] `HealthOS/Shared/docs/execution/02-status-and-tracking.md` has a PHASE-1-SETTLER-TERRITORY entry
- [ ] `make validate-docs` passes
