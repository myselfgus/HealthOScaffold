...
7. **Tracking is mandatory.** After each task, update `HealthOS/Shared/docs/execution/02-status-and-tracking.md` and `HealthOS/Shared/docs/execution/18-healthos-xcode-agent-task-tracker.md` in the same work unit.
...
```
1.  HealthOS/Shared/docs/execution/20-documental-todos-work-plan.md              ← tasks 7–9 in the master plan
2.  HealthOS/Shared/docs/execution/01-agent-operating-protocol.md                ← operating rules
3.  HealthOS/Shared/docs/execution/18-healthos-xcode-agent-task-tracker.md       ← Streams C, D, F definitions + working rules
4.  HealthOS/Shared/docs/execution/17-healthos-xcode-agent-migration-plan.md     ← WS-2, WS-3 objectives
5.  HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md                 ← target arch (READ IN FULL)
6.  HealthOS/Shared/docs/architecture/46-apple-sovereignty-architecture.md       ← Apple boundary doc (for Stream F)
7.  HealthOS/Shared/docs/architecture/44-project-steward-agent.md                ← Steward doc (context for Stream D)
8.  HealthOS/Shared/docs/execution/02-status-and-tracking.md                     ← current status (top 80 lines)
9.  HealthOS/Constructor/ts/agent-infra/healthos-steward/src/runtime/types.ts            ← current runtime types baseline
10. HealthOS/Constructor/ts/agent-infra/healthos-steward/README.md                       ← package baseline description
```

After reading, confirm:
- `HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md` exists → YES/NO
- `HealthOS/Shared/docs/architecture/46-apple-sovereignty-architecture.md` exists → YES/NO
- `HealthOS/Constructor/ts/agent-infra/healthos-steward/src/runtime/types.ts` exists → YES/NO

If any file is missing, read what is available and note the gap explicitly.

Also note: the working rules in `HealthOS/Shared/docs/execution/18-healthos-xcode-agent-task-tracker.md` include:
...
The current `HealthOS/Constructor/ts/agent-infra/healthos-steward/` baseline (from XA-002) contains:
...
**Source**: `HealthOS/Shared/docs/execution/18-healthos-xcode-agent-task-tracker.md` → Stream C, XA-004
**Target file**: `HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md` (add new section)
**Supporting update**: `HealthOS/Shared/docs/execution/18-healthos-xcode-agent-task-tracker.md` (mark Stream C design-complete)
...
### What to add to `HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md`
...
exists in HealthOS/Constructor/ts/agent-infra/healthos-steward/ as of this writing. This specification is the design
...
Update `HealthOS/Shared/docs/execution/18-healthos-xcode-agent-task-tracker.md`:
- Change Stream C status from `TODO` to `design-complete`.
- Add note: "Design spec added to HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md ## Tool runtime contracts"
...
**Source**: `HealthOS/Shared/docs/execution/18-healthos-xcode-agent-task-tracker.md` → Stream D
**Target file**: `HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md` (add new section)
**Supporting update**: `HealthOS/Shared/docs/execution/18-healthos-xcode-agent-task-tracker.md` (mark Stream D design-complete)
...
exists in HealthOS/Constructor/ts/agent-infra/healthos-steward/ as of this writing beyond the basic
...
- Add note: "Design spec added to HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md ## Model backend contract"
...
**Source**: `HealthOS/Shared/docs/execution/18-healthos-xcode-agent-task-tracker.md` → Stream F
**Target file**: `HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md` (add new section)
**Supporting update**: `HealthOS/Shared/docs/execution/18-healthos-xcode-agent-task-tracker.md` (mark Stream F design-complete)
...
The key architectural boundary from `HealthOS/Shared/docs/architecture/46-apple-sovereignty-architecture.md`:
...
collector or Xcode bridge is implemented in HealthOS/Constructor/ts/agent-infra/healthos-steward/ as of this
...
- Add note: "Design spec added to HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md ## Xcode context envelope"
...
HealthOS/Shared/docs/execution/20-documental-todos-work-plan.md Phase 3.

Files touched:
- HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md (3 new sections added)
...
git add HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md \
        HealthOS/Shared/docs/execution/18-healthos-xcode-agent-task-tracker.md
...
New section: ## Tool runtime contracts in HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md
...
New section: ## Model backend contract in HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md
...
New section: ## Xcode context envelope in HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md
...
- [ ] `HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md` contains `## Tool runtime contracts` with all type definitions, 6 categories, and 6 fail-closed rules
- [ ] `HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md` contains `## Model backend contract` with architectural position statement, all type definitions, and 9 fail-closed rules
- [ ] `HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md` contains `## Xcode context envelope` with all type definitions, 6 privacy invariants, 4 failure modes, and MCP transport note
- [ ] Stream C marked `design-complete` in `HealthOS/Shared/docs/execution/18-healthos-xcode-agent-task-tracker.md`
- [ ] Stream D marked `design-complete` in `HealthOS/Shared/docs/execution/18-healthos-xcode-agent-task-tracker.md`
- [ ] Stream F marked `design-complete` in `HealthOS/Shared/docs/execution/18-healthos-xcode-agent-task-tracker.md`
- [ ] `HealthOS/Shared/docs/execution/02-status-and-tracking.md` has PHASE-3-XCODE-AGENT-STREAMS entry
- [ ] `make validate-docs` passes
...
When Phase 3 is done, verify that the full documentary plan (`HealthOS/Shared/docs/execution/20-documental-todos-work-plan.md`) is now complete:
...
If all 9 tasks are DONE, update `HealthOS/Shared/docs/execution/20-documental-todos-work-plan.md` status line from:
```
