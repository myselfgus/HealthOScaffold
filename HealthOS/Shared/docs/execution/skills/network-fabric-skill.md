...
## Required reading
`HealthOS/Shared/docs/architecture/04-networking.md`, `15-mesh-provider.md`, `14-operations-runbook.md`.

## Invariants
Single-node bootstrap is minimum; mesh transport is not clinical authorization.

## Main files
`HealthOS/Support/ops/network/*`, `HealthOS/Shared/docs/architecture/04-networking.md`, `15-mesh-provider.md`.
