...
Use this skill when implementing or modifying Steward and its extension surfaces (`healthos-steward`, `healthos-forge-mcp`, `HealthOS/Constructor/Steward/`).
...
- `HealthOS/Constructor/Steward/`: derived memory, sessions, handoffs, policies, and state.
...
- `HealthOS/Shared/docs/architecture/44-project-steward-agent.md` (historical reference only)
- `HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md` (Steward for Xcode target architecture)
- `HealthOS/Shared/docs/architecture/46-apple-sovereignty-architecture.md` (Apple sovereignty thesis)
- `HealthOS/Shared/docs/execution/17-healthos-xcode-agent-migration-plan.md` (migration plan)
- `HealthOS/Constructor/ts/agent-infra/healthos-forge-mcp/` (repository-maintenance MCP seam)
...
4. `HealthOS/Shared/docs/execution/02-status-and-tracking.md`
5. `HealthOS/Shared/docs/execution/14-final-gap-register.md`
6. `HealthOS/Shared/docs/architecture/45-healthos-xcode-agent.md`
7. `HealthOS/Shared/docs/architecture/46-apple-sovereignty-architecture.md`
8. `HealthOS/Shared/docs/execution/17-healthos-xcode-agent-migration-plan.md`
...
- `HealthOS/Shared/docs/`, tracking, and TODO updates are included in same work unit
