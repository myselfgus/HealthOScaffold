...
- [x] referral/prescription draft lineage now carries a small resolved-view-derived operational guidance object with actor, primitive families, reasoning boundary, `gos.use.derive.*` operation, draft-only, gate-required, and non-authorizing flags
- [~] AACI now has a runtime-agnostic/subagent-aware GOS mediation seam (`AACIGOSMediationContext` + `AACIGOSRuntimeResolver`) and standardized `gos.use.*` operation resolution applied to current first-slice capture/transcription/context/SOAP/referral/prescription paths; broader mode-level AACI adoption beyond those runtime paths still remains open
...
- [x] examples of allowed Scribe/Veridia/CloudClinic consumption patterns documented
...
- `HealthOS/Shared/docs/adr/0011-governed-operational-spec-is-subordinate-to-core.md`
- `HealthOS/Shared/docs/architecture/29-governed-operational-spec.md`
- `HealthOS/Shared/docs/architecture/30-gos-authoring-and-compiler.md`
- `HealthOS/Shared/docs/architecture/31-gos-runtime-binding.md`
- `HealthOS/Shared/docs/architecture/32-gos-bundles-and-lifecycle.md`
- `HealthOS/Shared/docs/architecture/33-gos-app-consumption-patterns.md`
- `HealthOS/Shared/docs/architecture/34-gos-review-and-activation-policy.md`
- `HealthOS/Shared/docs/execution/08-gos-stabilization-handoff.md`
- `HealthOS/Shared/docs/execution/09-local-validation-checklist.md`
...
- `HealthOS/Tier1-Mestral-Core/Schemas/governed-operational-spec-review-record.schema.json`
- `HealthOS/Tier1-Mestral-Core/Schemas/governed-operational-spec-lifecycle-audit.schema.json`
- `HealthOS/Tier2-GOS-Runtimes/GOS/specs/aaci.first-slice.gos.yaml`
- `HealthOS/Constructor/ts/packages/healthos-gos-tooling/`
...
- `HealthOS/Tier2-GOS-Runtimes/Sources/HealthOSAACI/GOSBindings.swift`
- `HealthOS/Tier2-GOS-Runtimes/Sources/HealthOSAACI/GOSRuntimeActivation.swift`
- `HealthOS/Tier2-GOS-Runtimes/Sources/HealthOSSessionRuntime/SessionRunner.swift`
- `HealthOS/Tier2-GOS-Runtimes/Bootstrap/gos/system/HealthOS/Tier2-GOS-Runtimes/GOS/`
