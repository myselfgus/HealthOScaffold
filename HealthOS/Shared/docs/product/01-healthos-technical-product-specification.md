...
Legacy references:
- `HealthOS/Shared/docs/reference/mental-space-legacy/4-asl.ts`
- `HealthOS/Shared/docs/reference/mental-space-legacy/5-vdlp.ts`
- `HealthOS/Shared/docs/reference/mental-space-legacy/6-gem.ts`
- normalization reference: `HealthOS/Shared/docs/reference/mental-space-legacy/2-process-transcriptions.ts`
...
- `HealthOS/Shared/docs/architecture/17-glossary.md`
...
- `HealthOS/Shared/docs/architecture/34-gos-lifecycle-and-storage.md`
...
- `HealthOS/Shared/docs/reference/mental-space-legacy/2-process-transcriptions.ts`
- `HealthOS/Shared/docs/reference/mental-space-legacy/4-asl.ts`
- `HealthOS/Shared/docs/reference/mental-space-legacy/5-vdlp.ts`
- `HealthOS/Shared/docs/reference/mental-space-legacy/6-gem.ts`
...
- `HealthOS/Constructor/ts/packages/runtime-async/`
- `HealthOS/Constructor/ts/packages/runtime-user-agent/`
