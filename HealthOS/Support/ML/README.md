...
```bash
swift HealthOS/Support/ML/transcript-normalizer/TrainTranscriptNormalizer.swift
```

**Output destination:** `HealthOS/Tier2-GOS-Runtimes/Sources/HealthOSProviders/Resources/TranscriptNormalizer.mlmodel`
