...
struct CloudClinicEntrypoint {
    static func main() {
        ...
        print("CloudClinic Stage: scaffold placeholder - no final UI shell, no session behavior, no clinical authority (see HealthOS/Shared/docs/architecture/13-cloudclinic.md)")
    }
}
