...
let targets: [TargetSpec] = [
    ...
    .init(name: "CustomSDK",               kind: .library,     dependencies: ["HealthOSCore"],                                                      resources: []),
    .init(name: "HealthOSBoundary",        kind: .library,     dependencies: ["CustomSDK", "HealthOSCore", "HealthOSGOS", "HealthOSAACI", "HealthOSMSR", "HealthOSAsyncRuntime", "HealthOSUserAgentRuntime", "HealthOSServiceRuntime", "HealthOSSessionRuntime"], resources: []),
    ...
    .init(name: "HealthOSBoundaryTests",   kind: .test,        dependencies: ["HealthOSBoundary", "CustomSDK"],                                     resources: []),
    .init(name: "StagePackageStructureTests", kind: .test,     dependencies: [],                                                                     resources: []),
