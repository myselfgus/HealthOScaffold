...
CloudClinic is the **service-operations surface** described in `docs/architecture/40-cloudclinic-service-operations-surface.md`. It hosts service-operations actors (admins, schedulers, billing, integrations) — it is **not** a clinical surface, and it does NOT carry HealthOS Core.
