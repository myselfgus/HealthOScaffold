...
- [ ] Criar `Localizable.xcstrings` (ou `Localizable.strings`) para HealthOSScribeApp
- [ ] Criar `Localizable.xcstrings` para HealthOSVeridiaApp (preparatório — UI ainda não implementada)
- [ ] Criar `Localizable.xcstrings` para HealthOSCloudClinicApp (preparatório)
...
### 2.2 HealthOSScribeApp — UI (SwiftUI)
...
### 2.3 HealthOSScribeApp — ViewModel (mensagens de erro/estado)
...
### 2.4 HealthOSVeridiaApp e HealthOSCloudClinicApp
...
### 3.1 Testes de UI (HealthOSScribeApp)
...
### 3.3 Smoke tests
- [ ] `swift run HealthOSScribeApp --smoke-test` → verificar saídas em pt-BR onde aplicável
- [ ] `swift run HealthOSVeridiaApp --smoke-test` → verificar mensagens de sucesso/falha localizadas
- [ ] `swift run HealthOSCloudClinicApp --smoke-test` → verificar mensagem de sucesso localizada
