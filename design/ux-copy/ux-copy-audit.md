...
- **Texto atual:** `"HealthOSVeridia: patient health identity app scaffold placeholder - no final UI shell, no clinical authority (see docs/architecture/12-veridia.md)"`
...
- **Texto atual:** `"HealthOSCloudClinic: scaffold placeholder - no final UI shell, no session behavior, no clinical authority (see docs/architecture/13-cloudclinic.md)"`
