...
code_references:
  ...
  - path: swift/Sources/HealthOSSessionRuntime/SessionRunner.swift
    type: impl
    note: `SessionRunner` opera com `root: URL` local — sem assumir multi-host.
  - path: swift/Sources/HealthOSCore/DirectoryLayout.swift
    type: protocol
...
- **Pressupostos e restrições.** (a) Apple Silicon é a plataforma alvo (`.macOS(.v26)` em [swift/Package.swift:6](../../swift/Package.swift:6)); (b) operadores podem rodar em hardware próprio; (c) ADR-0009 esclarece que single-node é forma de bootstrap, não topologia permanente.
...
- **Fronteiras entre módulos.** Mantidas como em [swift/Package.swift](../../swift/Package.swift). Single-node não relaxa a hierarquia constitucional (ADR-0001).
...
- **Testes.** `make swift-build`, `make swift-test`, `make swift-smoke` formam o gate. Suite `HealthOSTests` ([swift/Tests/HealthOSTests/](../../swift/Tests/HealthOSTests/)) cobre fronteiras críticas single-node.
