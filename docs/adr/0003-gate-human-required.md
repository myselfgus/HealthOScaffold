...
code_references:
  - path: swift/Sources/HealthOSCore/GateContracts.swift
    type: protocol
  ...
  - path: swift/Sources/HealthOSCore/RegulatoryGovernance.swift
    type: impl
  ...
  - path: swift/Tests/HealthOSTests/RegulatoryGovernanceTests.swift
    type: test
...
- ator humano explícito com habilitação apropriada (validada em [swift/Sources/HealthOSCore/UserSovereigntyContracts.swift](../../swift/Sources/HealthOSCore/UserSovereigntyContracts.swift) e governança em [swift/Sources/HealthOSCore/RegulatoryGovernance.swift](../../swift/Sources/HealthOSCore/RegulatoryGovernance.swift));
...
- **Fronteiras entre módulos.** Tipos canônicos em `HealthOSCore` ([swift/Sources/HealthOSCore/GateContracts.swift](../../swift/Sources/HealthOSCore/GateContracts.swift)). Runtimes (AACI/MSR/SessionRuntime) emitem `GateRequest` e consomem `GateResolution`. Apps oferecem UX para resolver. **Apps NÃO definem novos tipos de gate.**
