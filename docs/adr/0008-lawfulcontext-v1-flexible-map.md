...
`HealthOSCore` define `CoreLawfulContext` ([swift/Sources/HealthOSCore/CoreLaw.swift](../../swift/Sources/HealthOSCore/CoreLaw.swift)) com campos canônicos tipados **e** um campo `raw: [String: String]` para o transporte flexível.
...
- **Positivas.**
  ...
  - Documentação fornece exemplos de lawfulContext canônico (em [docs/architecture/](../architecture/)).
