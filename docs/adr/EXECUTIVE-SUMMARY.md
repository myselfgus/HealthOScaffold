...
Escopo: ADRs 0001-0012 elevadas ao template canônico, validadas contra [swift/Package.swift](../../swift/Package.swift) e árvore de código.
...
- **Validação cruzada** das decisões contra a topologia de dependências em [swift/Package.swift](../../swift/Package.swift) — **zero violações** detectadas.
...
Todas as 12 ADRs **respeitam e dependem de** a hierarquia em [swift/Package.swift](../../swift/Package.swift):
...
| R5 | Schema drift entre Swift e TS no seam | ADR-0006 | Schemas em [schemas/](../../schemas/); `make validate-schemas` em CI; testes de contrato em ambos os lados. |
