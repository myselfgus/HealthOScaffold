...
| Apps/UI overall | scaffolded contract / implemented seam (Scribe minimal) | app-boundary doctrine, contracts, native macOS 26+ UI scope, and ADR-0013 app-agnostic ordering exist | mainly boundary tests + Scribe/Veridia smoke; design-system scope doc only | no final UX for initial reference apps; no HealthOS control panel executable; CloudClinic charter incomplete | complete platform/runtime surfaces + app charters before app wiring |
