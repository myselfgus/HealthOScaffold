...
|---|---|---|---|---|---|---|---|---|---|---|
| GAP-001 | RESOLVED | Cross-app surfaces | Cross-app shared envelope/safe-ref propagation was reconciled through APP-008 evidence. Remaining Veridia/CloudClinic work is app session wiring, not an RC blocker. ADR-0013 now blocks new app wiring until upstream mediated surfaces and App Charters are ready. | scaffolded contract / tested operational path | medium | resolved | medium | Product app wiring phase after Tier 1-4 readiness | `swift/Sources/HealthOSCore` + future app adapters | Swift boundary tests for Veridia/CloudClinic adapter wiring |
