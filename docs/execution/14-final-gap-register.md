...
|---|---|---|---|---|---|---|---|---|---|---|
| GAP-001 | RESOLVED | Cross-app surfaces | Cross-app shared envelope/safe-ref propagation was reconciled through APP-008 evidence. Remaining Sortio/CloudClinic work is app session wiring, not an RC blocker. | scaffolded contract / tested operational path | medium | resolved | medium | Product app wiring phase | `swift/Sources/HealthOSCore` + future app adapters | Swift boundary tests for Sortio/CloudClinic adapter wiring |
