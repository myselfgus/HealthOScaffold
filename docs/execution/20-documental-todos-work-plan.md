...
- **APP-011 (Veridia smoke-testable path) DONE em 2026-05-04** via PR #98 (VeridiaSessionFacade); o drift de tracker em `apps-and-interfaces.md` foi corrigido em 2026-05-07, e APP-012 permanece como o próximo wiring de app.
