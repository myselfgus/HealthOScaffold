...
- **APP-011 (Veridia smoke-testable path) DONE em 2026-05-04** via PR #98 (VeridiaSessionFacade); `apps-and-interfaces.md` ainda lista APP-011 sob `## READY` — drift de tracker não corrigido por este sync (requer edição em `docs/execution/todo/`).
