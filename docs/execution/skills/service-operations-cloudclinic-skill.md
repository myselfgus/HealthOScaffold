...
## Required reading
`docs/architecture/50-app-layer-boundary-and-reference-apps.md`, `13-cloudclinic.md`, `25-cloudclinic-screen-contracts.md`, `41-service-operations-cloudclinic-core-contracts.md`.
