...
## Required reading
`docs/architecture/50-app-layer-boundary-and-reference-apps.md`, `docs/architecture/12-veridia.md`, `docs/architecture/24-veridia-screen-contracts.md`, `docs/architecture/43-cross-app-coordination-shared-surfaces.md`.
