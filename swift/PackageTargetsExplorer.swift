...
//
// Demonstrates and explores the `targets` array defined in Package.swift (line 18).
//
...
//
// Run with: swift PackageTargetsExplorer.swift
...
// Mirrors the `targets:` array from Package.swift line 18 onward
